        ...
        public void run(String... args) throws Exception {
                ...
                if (consoleRepository.count() == 0) {
                        ...
                        Console NES = Console.builder()
                                ...
                                .quantityInStock(500)
                                .company("Nintendo")
                                .image("https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/NES-Console-Set.png/640px-NES-Console-Set.png")
                                .build();
                        consoleList.add(NES);
                        ...
                        Product MarioBros = Product.builder()
                                ...
                                .productQuantity(4)
                                .console(NES)
                                .image("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/763e4a4f-0453-48cd-96ef-d2aba6b7d98d/d9xbnei-bc7f5aa2-4ce0-439a-989a-198fb57ed865.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NdPE7VMBNGiXWJqi6ckd6y3iucc5i4SrMXKFe0OwhQI")
                                .build();
